...
return new class extends Migration
{
    ...
    {
        $procedure = "DROP PROCEDURE IF EXISTS AllProductImportErrorL;
            CREATE PROCEDURE AllProductImportErrorL(IN P_vendor_id BIGINT UNSIGNED, IN v_type INT)
            BEGIN
            ...
            where (case when v_type=1 then tp.vendor_id IS NULL else tp.vendor_id=P_vendor_id end) AND tp.import_type=0 AND tp.diamond_type=2 order by tp.id;
    ...
    {
        // Schema::dropIfExists('_all_product_import_error_l_procedure');
    }
};
